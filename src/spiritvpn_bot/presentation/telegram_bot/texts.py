...
WELCOME_CAPTION = (
    "🌀 SpiritVPN — ваш приватный доступ в интернет. Для провайдера это "
    "выглядит как обычный защищённый сайт — никто не узнает, что вы "
    "пользуетесь VPN.\n\n"
...
FALLBACK_TEXT = (
    "Не могу распознать это сообщение. Нажмите «Открыть приложение» ниже — там "
    "все нужные функции. Если нужна помощь — напишите /support."
)
